...
namespace Game.UI.Lobby
{
    ...
    public sealed class LobbyScreenView : MonoBehaviour
    {
        ...
        public static LobbyScreenView Create(
            Transform parent,
            ...
            bool showSafeAreaDebugOverlay)
        {
            ...
            var screenView = screenObject.GetComponent<LobbyScreenView>();
            screenView.Setup(
                safeAreaRect,
                panelRect,
                panelLayout,
        ...
        private void ApplyResponsiveLayout(bool force)
        {
            ...
            float buttonWidth = Mathf.Min(MobileLayout.ClampScaled(ButtonWidth, MinButtonWidth, ButtonWidth, scale), safeRect.width - 64f);
            ...
            if (_panelRect != null)
            {
                _panelRect.sizeDelta = new Vector2(
                    Mathf.Min(PanelWidth, Mathf.Max(MinPanelWidth, safeRect.width - 64f)),
                    Mathf.Min(safeRect.height - 64f, 520f * scale));
            }
